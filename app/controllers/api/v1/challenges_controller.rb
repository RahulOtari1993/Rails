class Api::V1::ChallengesController < Api::V1::BaseController
  ...
  def index
    ...
    render_success 200, true, 'Challenges fetched successfully.', challenges.as_json
  end

  ## Fetch Particular Challenge Details
  def show
    challenge = @campaign.challenges.where(id: params[:id])
    render_success 200, true, 'Challenge details fetched successfully.', challenge.as_json
  end
end
