$(document).on("turbolinks:load", function () {
  ...
  var stepsWizard = $(".challenge-wizard").steps({
    ...
    onStepChanging: function (event, currentIndex, newIndex) {
      ...
      if (currentIndex == 1 && newIndex == 2) {
        if (
          $(".challenge-type-list.active").data("challenge-type") == "engage" &&
          ($(".challenge-type-list.active").data("challenge-parameters") ==
            "facebook" ||
            $(".challenge-type-list.active").data("challenge-parameters") ==
              "instagram")
        ) {
    ...
    onFinished: function (event, currentIndex) {
      ...
      if (
        $(
          `.${challengeType}-${challengeParameters}-div .question-wysiwyg-editor`
        ).length > 0
      ) {
        $(
          `.${challengeType}-${challengeParameters}-div .question-wysiwyg-editor`
  ...
  function getSocialImageName() {
    if ($("#challenge_parameters").val() == "facebook") {
      imageName = imageNeeded(
        $("#facebookBlockBody input[name='challenge[social_image]']")
      );
    } else if ($("#challenge_parameters").val() == "twitter") {
      imageName = imageNeeded(
        $("#twitterBlockBody input[name='challenge[social_image]']")
      );
    } else if ($("#challenge_parameters").val() == "linked_in") {
      imageName = imageNeeded(
        $("#linkedinBlogBody input[name='challenge[social_image]']")
      );
    } else {
      imageName = "";
    }
  ...
  function imageNeeded(element) {
    return element.hasClass("always-validate")
      ? element.val()
      : "image_not_needed.jpg";
  }
  ...
  function stepTwoContent(challengeType, challengeParameters) {
    ...
    $("." + challengeType + "-" + challengeParameters + "-div").addClass(
      "active-segment"
    );
    $("." + challengeType + "-" + challengeParameters + "-div input").prop(
      "disabled",
      false
    );
    $("." + challengeType + "-" + challengeParameters + "-div select").prop(
      "disabled",
      false
    );
    $("." + challengeType + "-" + challengeParameters + "-div hidden").prop(
      "disabled",
      false
    );
    ...
    if (
      ...
      (challengeParameters == "profile" ||
        challengeParameters == "quiz" ||
        challengeParameters == "survey")
    ) {
      $(
        "." + challengeType + "-" + challengeParameters + "-div .disabled-field"
      ).prop("disabled", true);
      $(
        "." +
          challengeType +
      ...
      if (
        ...
        $(
          ...
          if ($(this).hasClass("display-editor")) {
            $(this).show();
            $(
              `.${challengeType}-${challengeParameters}-div .question-box${$(
                this
              ).data("editor-identifire")} .non-wysiwyg-field`
            ).hide();
            new Quill(
              `.question-wysiwyg-editor${$(this).data("editor-identifire")}`,
              toolbar
            );
            $(
              `.question-wysiwyg-editor${$(this).data("editor-identifire")}`
    ...
    if (challengeType == "share" && challengeParameters == "facebook") {
      ...
      $(".share-twitter-div .social-description-txt").removeClass(
        "always-validate"
      );
    } else if (challengeType == "share" && challengeParameters == "twitter") {
      $(".share-twitter-div .social-description-txt").addClass(
        "always-validate"
      );
      $(".share-facebook-div .social-description-txt").removeClass(
        "always-validate"
      );
    }
  }
  ...
  $.validator.addMethod(
    ...
    function (value) {
      ...
      if (
        $(".step-two-container").hasClass("share-facebook-div") ||
        $(".step-two-container").hasClass("share-twitter-div")
      ) {
  ...
  $.validator.addMethod(
    "facebookSocialFeedConnection",
    function (value) {
      var step = $(".step-top-padding.current").data("step-id");
      var challengeType = $(".challenge-type-list.active").data(
  ...
  $.validator.addMethod(
    ...
    function (value) {
      ...
      if ($("#challenge_parameters").val() == "facebook") {
        socialDescription = $(
          "#facebookBlockBody .social-description-txt"
        ).val();
      } else if ($("#challenge_parameters").val() == "twitter") {
        socialDescription = $(
          "#twitterBlockBody .social-description-txt"
        ).val();
      } else if ($("#challenge_parameters").val() == "linked_in") {
        socialDescription = $(
          "#linkedinBlogBody .social-description-txt"
        ).val();
      } else {
        socialDescription = "";
      }
  ...
  $.validator.addMethod(
    ...
    function (value) {
      ...
      if (
        $(".step-two-container.video-youtube-div").hasClass("active-segment") ||
  ...
  $(".challenge-type-list").on("click", function (e) {
    ...
    var connectFacebook = $("#challenge_challenge_type").data(
      "connect-facebook"
    );
    stepTwoContent(
      $(this).data("challenge-type"),
      $(this).data("challenge-parameters")
    );

    if (
      $(this).data("challenge-type") == "engage" &&
      ($(this).data("challenge-parameters") == "facebook" ||
        $(this).data("challenge-parameters") == "instagram")
    ) {
      $(".step3-content-div").html(
        '<div class="new_challenge_box text-center"><div className="row offset-sm-1 col-sm-10 offset-lg-2 col-lg-8"><h4>No Reward Config Needed for this Type of Challenge</h4></div></div>'
      );
    } else {
      $(".step3-content-div").html("");
  ...
  $('[data-toggle="collapse"]').on("click", function (e) {
    if ($(this).parents(".accordion").find(".collapse.show")) {
      ...
      if (idx == 0) {
        ...
        $("#challenge_social_title").val(
          $("#facebookBlockBody .social-title-txt").val()
        );
        $("#challenge_social_description").val(
          $("#facebookBlockBody .social-description-txt").val()
        );
      } else if (idx == 1) {
        // Twitter
        ...
        $("#challenge_social_title").val(
          $("#twitterBlockBody .social-title-txt").val()
        );
        $("#challenge_social_description").val(
          $("#twitterBlockBody .social-description-txt").val()
        );
      } else if (idx == 2) {
        // LinkedIn
        ...
        $("#challenge_social_title").val(
          $("#linkedinBlogBody .social-title-txt").val()
        );
        $("#challenge_social_description").val(
          $("#linkedinBlogBody .social-description-txt").val()
        );
      }
  ...
  $(".add-challenge-user-segment").on("click", function (e) {
    let challengeUserSegmentsTemplate = $(
      "#challenge-user-segments-template"
    ).html();
  ...
  $("body").on("change", ".challenge-event-dd", function (e) {
    ...
    tableRow
      .find(".segment-conditions-container .segment-conditions-dd")
      .prop("disabled", true)
      .hide()
      .removeClass("error");
    tableRow
      .find(".segment-values-container select")
      .prop("disabled", true)
      .hide()
      .removeClass("error");
    tableRow
      .find(".segment-values-container input")
      .prop("disabled", true)
      .hide()
      .removeClass("error");
    ...
    tableRow
      .find(".segment-conditions-" + $(this).val())
      .show()
      .removeAttr("disabled");

    // Display Segment Values Inputs / Drop Downs
    tableRow
      .find(".segment-value-" + $(this).val())
      .show()
      .removeAttr("disabled");
    tableRow
      .find(".segment-value-" + $(this).val())
  ...
  $("body").on("focusout", ".social-title-txt", function (e) {
    if (
      $("#challenge_challenge_type").val() == "share" &&
      $("#challenge_parameters").val() == "facebook"
    ) {
  ...
  $("body").on("change", "#challenge_start_date", function (e) {
    $("#challenge_start").val(
      $("#challenge_start_date").val() + " " + $("#challenge_start_time").val()
    );
  });
  ...
  $("body").on("change", "#challenge_finish_date", function (e) {
    $("#challenge_finish").val(
      $("#challenge_finish_date").val() +
        " " +
        $("#challenge_finish_time").val()
    );
  });
  ...
  $("#challenge-list-table").DataTable({
    ...
    ajax: {
      url:
        "/admin/campaigns/" +
        $("#challenge-list-table").attr("campaign_id") +
    ...
    columns: [
      {
        ...
        render: function (data, type, row) {
          ...
          if (data.status == "draft") {
            html =
              '<i class="data_table_status_icon fa fa-circle-o fa_draft fa_circle_sm" aria-hidden="true"></i>';
          } else if (data.status == "active") {
            html =
              '<i class="data_table_status_icon fa fa-circle fa_active fa_circle_sm" aria-hidden="true"></i>';
          } else if (data.status == "scheduled") {
            html =
              '<i class="data_table_status_icon fa fa-circle-o fa_scheduled fa_circle_sm" aria-hidden="true"></i>';
          } else {
            html =
              '<i class="data_table_status_icon fa fa-circle fa_ended fa_circle_sm" aria-hidden="true"></i>';
          }
          html +=
            '<img src="' +
      ...
      },
      {
        ...
        render: function (data, type, row) {
          ...
          return (
            '<span class="challenge-name" data-challenge-id="' +
            data.id +
            '" data-campaign-id="' +
            data.campaign_id +
            '">' +
      ...
      },
      {
        ...
        render: function (data, type, row) {
          ...
          let action_html =
            "<div class='input-group' data-challenge-id ='" +
            data.id +
            "' data-campaign-id='" +
            data.campaign_id +
            "'>" +
          ...
          action_html =
            action_html +
            "<a class='dropdown-item' href = '/admin/campaigns/" +
            data.campaign_id +
            "/challenges/" +
            data.id +
            "/edit'" +
          ...
          action_html =
            action_html +
            "<a class='dropdown-item toggle-challenge-status' href='javascript:void(0);'><i class='feather icon-check-square'></i> " +
            actionText +
            "</a>";
  ...
  $("#challenge-list-table").on(
    "click",
    ".display-challenge-participants",
    function () {
  ...
  $(".article-content-editor").focusout(function () {
    $(".article-content-txt-area").val(
      $(".article-content-editor .ql-editor").html()
    );
  });
  ...
  $(".challenge-description-editor").focusout(function () {
    $(".challenge-description-txt-area").val(
      $(".challenge-description-editor .ql-editor").html()
    );
  });
  ...
  function initAutocomplete() {
    var map = new google.maps.Map(
      document.getElementById("location-challenge-map"),
      {
        ...
        if ($("#challenge_location_distance").val()) {
          ...
          mapCircle.push(
            new google.maps.Circle({
              ...
              map: map,
              center: {
                lat: parseFloat($(".location-latitude").val()),
                lng: parseFloat($(".location-longitude").val()),
              },
  ...
  $("#challenge_location_distance").on("change", function (e) {
    if (
      parseFloat($(".location-latitude").val()) != 0 &&
      parseFloat($(".location-longitude").val()) != 0 &&
      $("#challenge_location_distance").val()
    ) {
      var latLon = {
        lat: parseFloat($(".location-latitude").val()),
        lng: parseFloat($(".location-longitude").val()),
  ...
  $(".challenge-tags-filter")
    ...
    .on("select2:select", function (e) {
      ...
      tagHtml = replaceTagFields(
        tagTemplate,
        $(".challenge-tags-filter :selected").text(),
        $(".challenge-tags-filter :selected").val()
      );
  ...
  $("body").on(
    "click",
    ".challenge-filter-tag-selection .chip-closeable",
    function (e) {
      $(this).parent().parent().remove();
      applyFilters(generateFilterParams());
    }
  ...
  function replaceQuestionContainerFieldIds(
    stringDetails = 0,
    phaseCounter = 0,
    optionCounter = 0,
    optCounter = 0
  ...
  function changeCorrectCountOption(challengeType, challengeParameters) {
    if (challengeType == "collect" && challengeParameters == "quiz") {
      var dropDowns = $(`.${challengeType}-${challengeParameters}-div`).find(
        ".question-selector"
      );
      ...
      dropDowns.each(function (index) {
        if ($(this).val() != "wysiwyg") {
          $(".correct_answer_count_dd").append(
            $("<option/>", {
              value: counter,
              text: counter,
            })
  ...
  $(".add-challenge-question").on("click", function (e) {
    let questionTemplate = $(
      `#${$(this).data("type")}-question-template`
    ).html();
    let phaseCounter = Math.floor(Math.random() * 90000) + 10000;
    ...
    questionHtml = replaceQuestionContainerFieldIds(
      questionTemplate,
      phaseCounter,
      optionCounter,
      optCounter
    ...
    $(
      `.${challengeType}-${challengeParameters}-div .questions-container`
    ).append(questionHtml);
  ...
  $("body").on("change", ".question-selector", function (e) {
    ...
    $(
      `.${challengeType}-${challengeParameters}-div .question-box${customId} .options-container`
    ).hide();
    $(
      `.${challengeType}-${challengeParameters}-div .question-box${customId} .options-container input`
    ).prop("disabled", true);

    $(
      `.${challengeType}-${challengeParameters}-div .question-box${customId} .${selectedVal[0]}-container`
    ).show();
    $(
      `.${challengeType}-${challengeParameters}-div .question-box${customId} .${selectedVal[0]}-container .is-editable`
    ).prop("disabled", false);

    if (selectedVal[0] == "wysiwyg") {
      $(
        `.${challengeType}-${challengeParameters}-div .question-box${customId} .non-wysiwyg-field`
      ).hide();
      $(`.question-wysiwyg-editor${customId}`)
        .addClass("display-editor")
        .show();

      // Quill Editor Integration for Campaign Rules
      if (
        !$(`.question-wysiwyg-editor${customId}`).hasClass("editor-initialize")
      ) {
        $(`.question-wysiwyg-editor${customId}`).addClass("editor-initialize");

        if (
          !$(`.question-wysiwyg-editor${customId}`).hasClass("editor-added")
        ) {
  ...
  $("body").on("click", ".question_del_icon", function (e) {
    ...
    if (
      $(`.${challengeType}-${challengeParameters}-div .question_del_icon`)
        .length > 1
    ) {
      ...
      swalNotify(
        "Remove Question",
        "You can not remove all questions, Atleast one question needed."
      );
    }
  });
  ...
  $("body").on("click", ".que_edit_cross", function (e) {
    ...
    if (options > 2) {
      ...
      swalNotify(
        "Remove Option",
        "You can not remove all options, Atleast one option needed."
      );
    }
  });
  ...
  $("body").on("click", ".add-challenge-option", function (e) {
    ...
    optionHtml = replaceQuestionContainerFieldIds(
      optionHtml,
      phaseCounter,
      optionCounter,
      optCounter
    ...
    optionHtml = optionHtml.replace(
      oldImageOptionErrorClassName,
      newImageOptionErrorClassName
    );
    ...
    optionHtml = optionHtml.replace(
      oldImageOptionDataErrorClassName,
      newImageOptionDataErrorClassName
    );
  ...
  function manageQuestionSequence() {
    ...
    $(
      `.${challengeType}-${challengeParameters}-div .questions-container .question_box`
    ).each(function (index) {
      $(this)
        .find(".question-sequence-hidden")
        .val(index + 1);
    });
  }
