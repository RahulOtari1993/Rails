...
US_STATES_LIST = {
                  ...
                  "Maine" => 0, "Maryland" => 0, "Massachusetts" => 0, "Michigan" => 0, "Minnesota" => 0, "Mississippi" => 0,
                  "Missouri" => 0, "Montana" => 0, "Nebraska" => 0, "Nevada" => 0, "New Hampshire" => 0, "New Jersey" => 0,
                  "New Mexico" => 0, "New York" => 0, "North Carolina" => 0, "North Dakota" => 0, "Ohio" => 0, "Oklahoma" => 0,
                  "Oregon" => 0, "Pennsylvania" => 0, "Rhode Island" => 0, "South Carolina" => 0, "South Dakota" => 0,
                  "Tennessee" => 0, "Texas" => 0, "Utah" => 0, "Vermont" => 0, "Virginia" => 0, "Washington" => 0,
